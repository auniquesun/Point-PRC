...
class ScanObjectNN(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train_data, train_label = self.load_data(os.path.join(self.dataset_dir, self.variant, 'train_files.txt'))
        val_data, val_label = self.load_data(os.path.join(self.dataset_dir, self.variant, 'val_files.txt'))
        test_data, test_label = self.load_data(os.path.join(self.dataset_dir, self.variant, 'test_files.txt'))
        ...
        # sonn_base 中 train, val, test split 分别取 base classes
