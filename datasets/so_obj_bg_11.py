...
class ScanObjectNN_11(DatasetBase):
    ...
    def load_data(self, name2idx, split):
        ...
        for cls in os.listdir(self.dataset_dir):
            cls_dir = os.path.join(self.dataset_dir, cls)   # data/xset/sim2real/so_obj_bg_11/bed
            
            if os.path.isdir(cls_dir):
                dir_f = os.path.join(cls_dir, split)    # data/xset/sim2real/so_obj_bg_11/bed/train
                label = name2idx[cls]
